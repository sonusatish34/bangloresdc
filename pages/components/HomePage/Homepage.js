...
export default function Homepage({ data }) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className='flex p-5 justify-around xl:justify-between lg:p-8 flex-wrap bg-[#ffde32] rounded-md text-white mx-[14px] lg:mx-[58px] my-3 items-center font-sans'>
