  ...
  return (
    <div className='fixed lg:relative top-0 left-0 right-0 z-50 bg-white text-black shadow-md'>
      <div className='flex justify-between items-center lg:px-14'>
        <Marquee speed={75}>
          <div className={'flex p-1 text-xs gap-24 lg:text-xl '}>
            ...
            <p className='flex items-center gap-1 justify-center'><TbPointFilled /><span>Car Starts 77rs/hr, min 24hrs</span></p>
      ...
      <subhead className="">
        <div id='sub' className="flex bg-gray-800 justify-between text-white text-base py-2 px-3 lg:px-14">
          ...
          <div className="flex items-center gap-1">
            ...
            <h2 className='lg:text-2xl lg:font-bold'><Link href="tel:9986666395" target='_blank'>9986-666-395</Link></h2>
          </div>
        </div>
      </subhead>
      ...
      <div className="flex w-full lg:justify-between items-center z-50 fixed lg:relative bg-white lg:py-14  lg:pr-14 border-8 border-orange-100 lg:h-20 ">
        <div className=" flex">
          <Link className='' href={'/'}>
            <div className=' lg:pl-8 rounded-md flex gap-2 cursor-pointer items-center'>
              <Image
              ...
              <div className='w-48 text-black 2xl:w-full lg:w-96 al lg:mt-2'>
                <h1 className='font-semibold xl:text-xl lg:text-xl text-xs'>Self Drive Cars <span className='text-[#ffde32]'>Bangalore</span></h1>
                <p className='xs:text-xs lg:text-lg flex lg:pl-8 xs:pl-9'><span className='xs:text-[7px] lg:text-[10px]'>Powered By </span><span className='lg:text-[17px] font-bold text-blue-700 text-[10px] xs:text-[8px] pl-1'>LONG DRIVE CARS</span></p>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className='lg:hidden block'>
          <button
            ref={buttonRef}
            className="fixed top-[7rem] right-4 z-40"
        ...
        <nav
          ref={menuRef}
          className={`${isOpen ? 'block overflow-auto' : 'hidden'} w-11/12 h-fit absolute top-24 bg-gray-50 rounded-md  p-2 pt-6 lg:pr-16 right-0 z-50 transition-transform delay-2000 ease-out text-black`}
        ...
        >
          ...
          <ul className="pl-6 pt-1 pb-1 border-t-2 border-gray-200  font-semibold flex flex-col gap-2 bg-s items-start text-black">
          ...
          <div className="flex flex-col border-t-2 text-[#efca0a] border-gray-200 text-left gap-2 pl-6 pt-4 justify-center ">
            <p>For Booking Help Call</p>
            <div className="flex items-center   ">
              <ul className="">
                <li>Telangana, AP</li>
                <li className="font-bold text-2xl text-black"><Link href="tel:9666677405" target='_blank'>9666-677-405</Link></li>
              </ul>
            </div>
            <div className="flex items-center   ">
              <ul className="">
                <li>Bangalore</li>
                <li className="font-bold text-2xl text-black"><Link href="tel:9986666395" target='_blank'>9986-666-395</Link></li>
              </ul>
            </div>
          </div>
        </nav>
