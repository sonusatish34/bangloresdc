...
export default function car_products({ cars }) {
    ...
    return (
        <div className="produvt-page flex flex-col lg:flex-row gap-10 bg-slate-100 pb-11">
            ...
            <div className='w-full'>
                ...
                <div className="lg:grid xl:grid-cols-3 lg:grid-cols-2 gap-x- gap-y-8 flex flex-col gap items-center justify-center lg:max-w-7xl">
